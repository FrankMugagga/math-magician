...
> **[Math Magicians]** is a  "Math magicians" is a website for all fans of mathematics. It is a Single Page App (SPA) that allows users to:
...
- Use the following Commands:
      ...
      cd math-magician
      git@github.com:FrankMugagga/math-magician.git
...
Feel free to check the [issues page](https://github.com/FrankMugagga/math-magician/issues).
